...
use App\Traits\livewireComponentTraits\VendorComponent;
    
class Index extends Component
{
    use WithPagination, WithFileUploads, VendorComponent;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.vendor.index', $this->RenderData());
    }
