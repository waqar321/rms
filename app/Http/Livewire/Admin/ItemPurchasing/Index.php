...
namespace App\Http\Livewire\Admin\ItemPurchasing;
...
use App\Traits\livewireComponentTraits\ItemPurchasingComponent;
use Illuminate\Support\Facades\Redirect;
use Carbon\Carbon;

class Index extends Component
{
    use WithPagination, WithFileUploads, ItemPurchasingComponent;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.item-purchasing.index', $this->RenderData());
    }
    ...
    public function printOut()
    {
        ...
        if($this->showVendorDropdown)
        {
            ...
            {
                $this->dispatchBrowserEvent('no_user_error');
                return false;
            }
        }
    ...
    public function RowReceiptPrintOut(Purchase $Purchase)
    {
        $this->dispatchBrowserEvent('open-new-tab', ['url' => GetItemDetailsForPrinting($Purchase)]);
    }
