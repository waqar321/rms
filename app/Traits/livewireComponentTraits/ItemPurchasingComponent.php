...
trait ItemPurchasingComponent
{
    ...
    public function setMountData($id=null)
    {
        ...
        $this->pageTitle = 'ItemInventry Operation';
        $this->MainTitle = 'ItemInventryOperation';
        $this->paginateLimit = 200;
        // $this->items = Item::where('category_id', 12)->orderBy('order', 'ASC')->get();
        $this->items = Item::where('is_item_purchasing_product', 1)->orderBy('order', 'ASC')->get();
        // dd($this->items);
        // $this->categories = ItemCategory::where('id', 12)->get();
        // $this->categories = ItemCategory::orderBy('order', 'ASC')->get();
        // $this->categories = ItemCategory::whereIn('id', [1, 11, 12, 13, 14, 15, 16, 17])->orderBy('order', 'ASC')->get();
        $this->categories = ItemCategory::where('is_item_purchasing_category', 1)->orderBy('order', 'asc')->get();
        $this->cart = [];
    ...
    protected function RenderData()
    {
        ...
        $Purchases = Purchase::when($this->searchByID !== null, function ($query)
                                {
        ...
        $data['Purchases'] = $this->readyToLoad ? $this->PaginateData($Purchases) : [];
