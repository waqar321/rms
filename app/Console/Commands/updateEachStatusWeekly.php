...
class updateEachStatusWeekly extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'default:update-each-status-weekly';
     ...
     * @var string
     */
    protected $description = 'COD Update Each Status Weekly';
    ...
    public function handle()
    {
        ...
        $cron_job->status = 1;
        $cron_job->cron_name = 'default:update-each-status-weekly';
