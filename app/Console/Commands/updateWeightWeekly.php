...
class updateWeightWeekly extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'default:update_weight_weekly';
     ...
     * @var string
     */
    protected $description = 'COD Update Booking Weight Weekly';
    ...
    public function handle()
    {
        ...
        $cron_job->status = 1;
        $cron_job->cron_name = 'default:update_weight_weekly';
