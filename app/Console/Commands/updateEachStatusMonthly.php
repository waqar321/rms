...
class updateEachStatusMonthly extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'default:update-each-status-monthly';
     ...
     * @var string
     */
    protected $description = 'COD Update Each Status Monthly';
    ...
    public function handle()
    {
        ...
        $cron_job->status = 1;
        $cron_job->cron_name = 'default:update-each-status-monthly';
