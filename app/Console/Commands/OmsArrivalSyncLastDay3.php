...
class OmsArrivalSyncLastDay3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'default:oms-data-arrival3';
    ...
    public function handle()
    {
        ...
        $cron_job->status = 1;
        $cron_job->cron_name = 'default:oms-data-arrival3';
        ...
        $CN_LIST = array();
        $one_day_old = date('Y-m-d 00:00:01', strtotime('-15 day'));
        $maxSystemTime = date('Y-m-d H:i:s', strtotime($one_day_old.'-15 day'));
