...
function init_flot_chart() {
    if (void 0 !== $.plot) {
        ...
        var n = {
            ...
            colors: ["#FFCB05", "#3F97EB", "#72c380", "#6f7a8a", "#f7cb38", "#5a8022", "#2c7282"],
            shadowSize: 0,
            tooltip: !0,
            tooltipOpts: {
                content: "%s: %y.0",
        ...
        $("#chart_plot_01").length && ($.plot($("#chart_plot_01"), [e, a], {
            ...
            colors: ["rgba(126, 126, 126, 0.38)", "rgba(255, 203, 21, 0.38)"],
            xaxis: {
...
function init_JQVmap() {
    void 0 !== jQuery.fn.vectorMap && ($("#world-map-gdp").length && $("#world-map-gdp").vectorMap({
        map: "world_en",
...
function init_daterangepicker_reservation() {
    void 0 !== $.fn.daterangepicker && ($("#reservation").daterangepicker(null, function (e, a, t) {
        console.log(e.toISOString(), a.toISOString(), t)
...
function init_SmartWizard() {
    void 0 !== $.fn.smartWizard && ($("#wizard").smartWizard(), $("#wizard_verticle").smartWizard({
