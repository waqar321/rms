...
!function (t) {
    ...
    function _t(n, i) {
        ...
        function o() {
            n.addClass("fc"), n.on("click.fc", "a[data-goto]", function (e) {
                var n = t(this), i = n.data("goto"), r = _.moment(i.date), s = i.type,
        ...
        function f(e, n) {
            ...
            if (o) t.isFunction(o) ? (U.pushLoading(), o.call(U, q.clone(), Z.clone(), U.options.timezone, function (t) {
                ...
                if (l) {
                    ...
                    var h = t.extend({}, a || {}), g = J(e.startParam, U.options.startParam),
                        p = J(e.endParam, U.options.endParam), v = J(e.timezoneParam, U.options.timezoneParam);
    ...
    var te = /^\s*\d{4}-\d\d$/,
        ...
        ne = e.fn, ie = t.extend({}, ne), re = e.momentProperties;
