...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ecom_course_assign', function (Blueprint $table) {
            ...
            // $table->foreign('department_id')->references('department_id')->on('ecom_department')->onDelete('cascade');   //Assign to sub department
            $table->BigInteger('sub_department_id')->nullable();
            // $table->foreign('sub_department_id')->references('sub_department_id')->on('ecom_department')->onDelete('cascade');   //Assign to sub department
