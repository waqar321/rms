...
Route::post('/LectureAssessments', [LectureApiController::class, 'LectureAssessments']);
...
// =================== useless at a time ======================
    ...
    Route::post('/UpdateUserLectureResult', [LectureApiController::class, 'UpdateUserLectureResult'])->name('update.assessment');
