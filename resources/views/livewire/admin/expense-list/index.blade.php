    ...
    @section('title') {{ $MainTitle }} Listing  @endsection
        ...
        <div class="right_col" role="main">
            <div class="">
                    ...
                    @include('Admin.expense-list.add')
                    @include('Admin.expense-list.list')
...
@push('scripts')
    ...
    <script>
        ...
        window.addEventListener('deleted_scene', event =>
        {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Expense Item Deleted Successfully!',
                text: `The Expense Item ${name} has been deleted.`,
            });
        })

        window.addEventListener('ExpenseListUpdated', event =>
        {
