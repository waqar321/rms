    ...
    @section('title') {{ $MainTitle }} Listing  @endsection
        ...
        <div class="right_col" role="main">
            <div class="">
                    ...
                    @include('Admin.UserManagement.Role.add') 
                    
                    @include('Admin.UserManagement.Role.list') 
...
@push('scripts')
    ...
    <script>
        ...
        {
            // ApplyAllSelect2();
            // $('.multiplePermissions').select2('destroy').empty();  // Destroy existing Select2 instance and clear the content
