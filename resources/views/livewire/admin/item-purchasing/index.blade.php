    ...
    @section('title') {{ $MainTitle }} Listing  @endsection
        ...
        <div class="right_col" role="main">
            <div class="">
                    ...
                    @include('Admin.item_purchasing.add')
                    @include('Admin.item_purchasing.list')
...
@push('scripts')
    ...
    <script>
        ...
        $('#cart-body').on('change', '.qty-input', function()
        {
            ...
            var id  = +$tr.data('id');          // item id in cart
       ...
       $('#summary').on('click', '#print-slip', function()
       {
        ...
        $('.category_class').on('click', function(e)
        {
