...
@section('title') Category Listing @endsection
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        buttons: [
            {
                text: '<i class="la la-cogs"></i> Add Sub Category',
                className: 'btn btn-primary btn-sm add',
                action: function (e, dt, node, config) 
                {
                    window.location = '<?php echo url_secure('category-management/sub_category/add') ?>';
                },
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('category-management/sub_category') ?>',
            data: function (d) {
                d.ajax=1;
            },
            headers: headers,
        ...
        columns: [
            ...
            {data: 'id', name: 'id', class: 'align-middle id', text:'Sys ID#' ,download:false},
            {data: 'name', name: 'name', class: 'align-middle country_name',text:'Name',download:true},
            {data: 'parent_id', name: 'parent_id', class: 'align-middle parent_id',text:'Parent Category',download:true},
            {data: 'created_at', name: 'created_at', class: 'align-middle created_at',text:'Date Created',download:true},
