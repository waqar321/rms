    ...
    <div class="form-v10-content">
        <form id="myform" action="" novalidate="novalidate" data-parsley-validate class="form-horizontal form-label-left form-detail" method="post">
                ...
                <div class="form-row">
                    <div class="main">
                        <h1 class="text-alignment">
                            <a href="" class="typewrite" data-period="2000" data-type='[ "Welcome To COD LMS Portal", "Take Your Business To New Heights", "Pakistan Fastest Cash On Delivery Services"]'>
            ...
            <div class="form-right">
                <h2 style="color: white">LMS <b style="color: #ffca00">ADMIN</b> LOGIN</h2>
                <div class="form-row">
                ...
                <div class="separator">
                    ...
                    <br/>
                    <div>
                        <h1 class="text-alignment color-code"><?php echo 'LMS ADMIN'; ?></h1>
                        <p class="text-alignment color-code">©{{date('Y')}} All Rights Reserved. <?php echo 'LMS ADMIN'; ?>!</p>
                    </div>
                </div>
