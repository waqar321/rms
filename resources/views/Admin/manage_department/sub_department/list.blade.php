...
<div class="row" data-screen-permission-id="26">
                            ...
                            @if($readyToLoad)
                                @forelse($departmentListing as $department)
                                    <tr>
                                        ...
                                        <td>
                                            <a data-screen-permission-id="28" href="{{ api_url('department-management/sub_department/?id=') . base64_encode($department->id) }}" class="btn btn-primary">Edit</a>
                                            <button data-screen-permission-id="29" onclick="confirmDelete('{{ $department->id }}')" class="btn btn-danger">Delete</button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
