    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($Customer->is_active == 1)
                                                    <span class="fa fa-toggle-on toggle-icon" wire:click="updateStatus({{ $Customer->id }}, 0)"></span>
                                                @else
                                                    <span class="fa fa-toggle-off toggle-icon" wire:click="updateStatus({{ $Customer->id }}, 1)"></span>
                                                @endif
                                            </td>
                                            <td>
                                                <a data-screen-Customer-id="23" wire:click="EditData({{ $Customer->id }})" class="btn btn-primary">Edit</a>
                                                <button data-screen-Customer-id="24" onclick="confirmDelete('{{ $Customer->id }}')" class="btn btn-danger">Delete</button>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center"> <h2> No Cutomer Record Found!!! </h2></td>
                                        </tr>
                                    @endforelse
                                @endif 
                        ...
                        @include('Admin.partial.livewire.pagination', ['ModelListing' => $Customers, 'Model' => 'categoryListing'])       
