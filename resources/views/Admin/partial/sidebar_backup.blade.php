...
<div class="col-md-3 left_col menu_fixed mCustomScrollbar _mCS_1 mCS-autoHide">
    <div class="left_col scroll-view">
        ...
        <div class="navbar nav_title" style="border: 0;">
            <a href="{{ url_secure('') }}" class="site_title">  <h1 style="font-weight: bold;color: #343a40;">ABASEEN </h1></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li data-screen-permission-id="53">
                        <a href="<?php echo url_secure('/dashboard') ?>">
                            <i class="fa fa-home"></i> Dashboard
                        </a>
                    </li>
                    <li class="side-bar-menus" data-module-id="1"><a><i class="fa fa-group"></i> Manage Users <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li>
                        <a href="{{ route('AllZones') }}">
                            <!-- fa fa-bullseye  -->
                        <i class="fa fa-map-pin"></i> Zone  
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('AllShiftimes') }}">
                            <!-- fa fa-clock
                            fa fa-calendar-alt -->
