...
@section('title') Consignee Listing @endsection
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="69">
                                <div class="col-md-4 col-sm-4 col-xs-12">
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#datatable').DataTable({
            ...
            buttons: [
                {
                    text: '<i class="la la-cogs"></i> Add Consignee',
                    className: 'btn btn-primary btn-sm add',
                    action: function (e, dt, node, config) {
                        window.location = '<?php echo url_secure('manage_client/consignee/add') ?>';
                    },
                    init: function (dt, node, config) {
                        // Add custom data attributes to the button
                        $(node).attr('data-screen-permission-id', "66");
                    }
                },
            ],
            select: {
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo api_url('manage_client/consignee') ?>',
                data: function (d) {
            ...
            columns: [
                ...
                {data: 'id', name: 'ecom_consignee.id', class: 'align-middle id', text: 'Sys ID#', download: true},
                {
                    data: 'merchant_name',
                    name: 'ecom_merchant.merchant_name',
                    class: 'align-middle username',
                    text: 'Merchant Name',
                    download: true
                },
                {
                    ...
                    class: 'align-middle consignee_name limited',
                    text: 'Consignee Name',
                    download: true
                },
                {
                    ...
                    class: 'align-middle consignee_phone limited',
                ...
                },
                {
                    ...
                    class: 'align-middle city_name limited',
                    text: 'Consignee City',
                    download: true
                },
                {
        ...
        jQuery(function ($) {
            ...
            $('#export-csv').submit(function (e) {
                ...
                if (!$('#export').val()) {
                    ...
                    $.ajax({
                        url: '<?php  echo api_url('manage_client/consignee/downloadCsv')  ?>', // Replace with your backend URL
                        type: 'GET',
                        data: {
