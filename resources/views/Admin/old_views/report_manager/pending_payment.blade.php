...
@section('title') Pending Payments ( Delivered But Not Deposited ) @endsection
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="150">
                                <div class="col-md-4 col-sm-4 col-xs-12">
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo api_url('report_manager/pending_payments') ?>',
                data: function (d) {
                    d.ajax=1;
                    d.date = $('#date').val();
            ...
            columns: [
                ...
                {data: 'des_zoned', name: 'des_zone.zone', as: 'des_zoned', class: 'align-middle des_zoned',text:'Destination Zone' ,download:true},
                {data: 'title', name: 'ecom_status.title', class: 'align-middle title',text:'Status' ,download:true},
                {data: 'STATUS', name: 'ecom_arrival_oms.STATUS', class: 'align-middle STATUS',text:'Current Status' ,download:true},
                {data: 'cur_des_city_name', name: 'des_zone.city_name', as: 'cur_des_city_name', class: 'align-middle cur_des_city_name',text:'Current Destination' ,download:true},
                {data: 'current_zone', name: 'des_zone.zone', class: 'align-middle zone',text:'Current Zone',download:true},
        ...
        jQuery(function ($) {
            ...
            $('#export-csv').submit(function (e) {
                ...
                if (!$('#export').val()) {
                    ...
                    $.ajax({
                        url: '<?php  echo api_url('report_manager/pending_payments/downloadCsv')  ?>', // Replace with your backend URL
                        type: 'GET',
                        data: {
                        ...
                        success: function (response) {
                            ...
                            a.href = url;
                            a.download = 'pending_payment_report_' + new Date().toISOString().slice(0, 10) + '.csv';
