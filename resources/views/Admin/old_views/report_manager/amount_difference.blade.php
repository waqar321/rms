...
@section('title') Amount Difference Report @endsection
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Amount Difference Report </h2>
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="166">
                                <div class="col-md-4 col-sm-4 col-xs-12">
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('report_manager/amount_difference') ?>',
            data: function (d) {
                d.ajax=1;
                d.date = $('#date').val();
        ...
        columns: [
            ...
            {data: 'client', name: 'ecom_merchant.merchant_name', as:'Client_ID_Name', class: 'align-middle client',text:'Client',download:true},
            ...
            {data: 'amount_diff', name: 'ecom_booking_deposits.deposited_amount', as:'amount_diff', class: 'align-middle amount_diff',text:'Amount Diff' ,download:true},
            ...
            {data: 'deposit_slip_no', name: 'ecom_bank_transaction_detail.deposit_slip_no', class: 'align-middle deposit_slip_no',text:'Deposit Slip #',download:true},
            // {data: 'deposit_slip_no', name: 'ecom_bank_transaction_detail.deposit_slip_no', class: 'align-middle deposit_slip_no',text:'Deposit Slip #',download:true},
            // {data: 'deposit_slip_no', name: 'ecom_bank_transaction_detail.deposit_slip_no', class: 'align-middle deposit_slip_no',text:'Deposit Slip #',download:true},
    ...
    var columnNames2 = table.settings().init().columns.map(function (column) {
        if(column.download) {
            ...
            if(col_name == 'ecom_merchant.merchant_name'){
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('report_manager/amount_difference/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
                    ...
                    success: function (response) {
                        ...
                        a.href = url;
                        a.download = 'amount_difference_report_' + new Date().toISOString().slice(0, 10) + '.csv';
