            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="154">
                                <div class="col-md-4 col-sm-4 col-xs-12">
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('report_manager/invoice_report') ?>',
            data: function (d) {
                d.ajax=1;
                d.date = $('#date').val();
        ...
        columns: [
            ...
            {data: 'title', name: 'ecom_status.title', class: 'align-middle title',text:'Booked Packet Status',download:true},
            ...
            {data: 'shipment_type_name', name: 'ecom_shipment_type.shipment_type_name', class: 'align-middle shipment_type_name',text:'Shipment Type',download:true},
            {data: 'zone', name: 'central_ops_city.zone', class: 'align-middle zone',text:'Zone Name',download:true},
            ...
            {data: 'booked_packet_weight', name: 'ecom_bookings.booked_packet_weight', class: 'align-middle booked_packet_weight',text:'Weight',download:true},
            ...
            {data: 'packet_charges', name: 'ecom_bookings.packet_charges', class: 'align-middle packet_charges',text:'Packet Charges PKR',download:true},
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('report_manager/invoice_report/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
                    ...
                    success: function (response) {
                        ...
                        a.href = url;
                        a.download = 'invoice_report_' + new Date().toISOString().slice(0, 10) + '.csv';
