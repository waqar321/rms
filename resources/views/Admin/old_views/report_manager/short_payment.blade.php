...
@section('title') Short Payment in Bank @endsection
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('report_manager/short_payment') ?>',
            data: function (d) {
                d.ajax=1;
                d.date = $('#date').val();
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('report_manager/short_payment/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
                    ...
                    success: function (response) {
                        ...
                        a.href = url;
                        a.download = 'short_payment_report_' + new Date().toISOString().slice(0, 10) + '.csv';
