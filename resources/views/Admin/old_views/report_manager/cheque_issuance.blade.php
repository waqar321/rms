...
@section('title') Cheque Issuance Details @endsection
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="164">
                                <div class="col-md-4 col-sm-4 col-xs-12">
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('report_manager/cheque_issuance') ?>',
            data: function (d) {
                d.ajax=1;
                d.date = $('#date').val();
        ...
        columns: [
            ...
            {data: 'client_name', name: 'ecom_merchant.merchant_name', class: 'align-middle merchant_name',text:'Merchant Name',download:true},
            {data: 'invoice_cheque_holder_name', name: 'ecom_invoice.invoice_cheque_holder_name', class: 'align-middle invoice_cheque_holder_name',text:'Payee Name' ,download:true},
            {data: 'invoice_cheque_no', name: 'ecom_invoice.invoice_cheque_no', class: 'align-middle invoice_cheque_no',text:'Cheque No',download:true},
            {data: 'bank_ac_no', name: 'ecom_merchant_finance.bank_ac_no', class: 'align-middle bank_ac_no',text:'Bank Account No',download:true},
            {data: 'client_bank_name', name: 'client_bank.bank_name', as: 'client_bank_name', class: 'align-middle client_bank_name',text:'Client Bank',download:true},
            {data: 'payment_bank_name', name: 'payment_bank.bank_name', as: 'payment_bank_name', class: 'align-middle payment_bank_name',text:'Payment Bank',download:true},
            {data: 'invoice_cheque_amount', name: 'ecom_invoice.invoice_cheque_amount', class: 'align-middle invoice_cheque_amount',text:'Cheque Amount(PKR)',download:true},
            {data: 'created_at', name: 'ecom_invoice.created_at', class: 'align-middle created_at',text:'Created_at',download:true},
            {data: 'updated_at', name: 'ecom_invoice.updated_at', class: 'align-middle updated_at',text:'Updated at',download:true},
            {data: 'shipper_id', name: 'ecom_invoice.shipper_id', class: 'align-middle shipper_id',text:'Shipper Id',download:true},
            {data: 'shipper_name', name: 'shipper.merchant_name',as:'shipper_name', class: 'align-middle shipper_name',text:'Shipper Name',download:true},
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('report_manager/cheque_issuance/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
                    ...
                    success: function (response) {
                        ...
                        a.href = url;
                        a.download = 'cheque_issuance_report_' + new Date().toISOString().slice(0, 10) + '.csv';
