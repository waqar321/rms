...
@section('title') Received Payments @endsection
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-3 col-xs-12">
                                    <label class="control-label col-md-12 col-sm-12 col-xs-12">Invoice Status</label>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <select class="form-control select2" name="is_paid" id="is_paid" onchange="search()">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="152">
                                <div class="col-md-4 col-sm-4 col-xs-12">
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('report_manager/received_payments') ?>',
            data: function (d) {
                d.ajax=1;
                d.date = $('#date').val();
        ...
        columns: [
            ...
            {data: 'deposited_amount', name: 'ecom_booking_deposits.deposited_amount', class: 'align-middle deposited_amount',text:'Deposited Amount' ,download:true},
            {data: 'deposit_date', name: 'ecom_booking_deposits.created_at', class: 'align-middle deposit_date',text:'Deposited Date' ,download:true},
            {data: 'invoice_cheque_no', name: 'ecom_bookings.invoice_cheque_no', class: 'align-middle invoice_cheque_no',text:'Cheque #' ,download:true},
            {data: 'invoice_cheque_date', name: 'ecom_bookings.invoice_cheque_date', class: 'align-middle invoice_cheque_date',text:'Cheque Date' ,download:true},
            {data: 'ibft', name: 'ecom_bookings.invoice_cheque_no', as:'ibft', class: 'align-middle ibft',text:'IBFT #' ,download:true},
            // {data: 'invoice_cheque_date', name: 'ecom_bookings.invoice_cheque_date', class: 'align-middle invoice_cheque_date',text:'Transfered To Shipper' ,download:true}
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('report_manager/received_payments/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
                    ...
                    success: function (response) {
                        ...
                        a.href = url;
                        a.download = 'received_payment_report_' + new Date().toISOString().slice(0, 10) + '.csv';
