...
@section('title') Payment Made To Clients @endsection
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="160">
                                <div class="col-md-4 col-sm-4 col-xs-12">
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('report_manager/payment_made_client') ?>',
            data: function (d) {
                d.ajax=1;
                d.date = $('#date').val();
        ...
        columns: [
            ...
            {data: 'title', name: 'ecom_status.title', as: 'title', class: 'align-middle title',text:'Status',download:true},
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('report_manager/payment_made_client/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
                    ...
                    success: function (response) {
                        ...
                        a.href = url;
                        a.download = 'payment_made_to_client_report_' + new Date().toISOString().slice(0, 10) + '.csv';
