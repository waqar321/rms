...
@section('title') City Wise Packets Status Report @endsection
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> City Wise Packets Status Report </h2>
    ...
    <script>
        ...
        $("#generate").validate({
            ...
            submitHandler: function (form, event) {
                ...
                $.ajax({
                    url: '<?php echo api_url('report_manager/city_wise_packet_status_counts/generate'); ?>',
                    method: 'POST',
                    data: data,
                    headers: headers,
        ...
        function summaryReportData(data) {
            ...
            var summaryDataTable1 = `<h3>City Wise Packets Status Report</h3>
...
<script>
    ...
    function exportToExcel() {
        ...
        XLSX.writeFile(wb, 'CiyWisePacketsStatusReport.xlsx');
    }
