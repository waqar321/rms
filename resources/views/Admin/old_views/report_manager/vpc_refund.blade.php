...
@section('title') VPC Refund @endsection
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="195">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th>VPC Created By</th>
                                    <th>VPC Creator Sys Id</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('report_manager/vpc_refund') ?>',
            data: function (d) {
                d.ajax=1;
                d.date = $('#date').val();
        ...
        columns: [
            ...
            {data: 'date_return', name: 'ecom_bookings.date_return', class: 'align-middle date_return',text:'Delivery Return Date' ,download:true},
            ...
            {data: 'zone', name: 'central_ops_city.zone', class: 'align-middle zone_name',text:'Origin Zone',download:true},
            {data: 'des_name', name: 'des_city.city_name', as: 'des_name', class: 'align-middle city_name',text:'Destination City',download:true},
            {data: 'merchant_name', name: 'ecom_merchant.merchant_name', class: 'align-middle merchant_name',text:'Shipper Name' ,download:true},
            {data: 'merchant_address1', name: 'ecom_merchant.merchant_address1', class: 'align-middle merchant_address1',text:'Shipper Address' ,download:true},
            {data: 'merchant_phone', name: 'ecom_merchant.merchant_phone', class: 'align-middle merchant_phone',text:'Shipper Phone' ,download:true},
            ...
            {data: 'consignee_address', name: 'ecom_consignee.consignee_address', class: 'align-middle consignee_address',text:'Consignee Address' ,download:true},
            {data: 'username', name: 'ecom_admin_user.username', class: 'align-middle username',text:'VPC Creator' ,download:true},
            {data: 'admin_user_id', name: 'ecom_bookings.admin_user_id', class: 'align-middle admin_user_id',text:'VPC Creator System ID' ,download:true},
        ],
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('report_manager/vpc_refund/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
                    ...
                    success: function (response) {
                        ...
                        a.href = url;
                        a.download = 'vpc_refund_report_' + new Date().toISOString().slice(0, 10) + '.csv';
