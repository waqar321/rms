                        ...
                        <div class="x_content">
                            ...
                            <form id="change-password" action="" novalidate="novalidate" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <div class="form-group">
                                        <a href="<?php echo url_secure('manage_client/merchant') ?>"><button class="btn btn-danger cancel-button" type="button">Cancel</button></a>
            ...
            submitHandler: function (form, event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?php echo api_url('manage_client/client/change_password'); ?>',
                            method: 'POST',
                            data:data,
