        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <div class="col-md-6">
                            <h2>Cargo Booking Send<small>Listing</small></h2>
                        </div>
                        <div class="col-md-6" style="display: flex; justify-content: flex-end;">
                            <label class="control-label col-md-12 col-sm-12"></label>
                            <a class="btn btn-primary" href="<?php echo base_url('manage/cargo/send/add') ?>">Add</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <label class="control-label col-md-12 col-sm-12">Destination City</label>
                            <div class="col-md-12 col-sm-12">
                                <select class="form-control">
