...
@section('title') Shipment Type Listing @endsection
@section('content')
<!-- page content -->
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        buttons: [
            {
                text: '<i class="la la-cogs"></i> Add Shipment Type',
                className: 'btn btn-primary btn-sm add',
                action: function (e, dt, node, config) {
                    window.location = '<?php echo url_secure('manage/shipment_type/add') ?>';
                }
            },
        ],
        select: {
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('manage/shipment_type/index') ?>',
            data: function (d) {
                d.ajax = 1;
            },
            headers: headers,
        ...
        columns: [
            ...
            {data: 'id', name: 'ecom_shipment_type.id', class: 'align-middle id',text:'Sys ID#' ,download:true},
            {data: 'shipment_type_name', name: 'ecom_shipment_type.shipment_type_name', class: 'align-middle shipment_type_name',text:'Shipment Type Name',download:true},
            {data: 'shipment_type_code', name: 'ecom_shipment_type.shipment_type_code', class: 'align-middle shipment_type_code',text:'Shipment Type Code',download:true},
            {data: 'created_at', name: 'ecom_shipment_type.created_at', class: 'align-middle created_at',text:'Date Created',download:true},
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('manage/shipment_type/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
