...
@section('title') Divisions Listing @endsection
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="17">
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('manage/divisions/index') ?>',
            data: function (d) {
                d.ajax = 1;
            },
            headers: headers,
        ...
        columns: [
            ...
            {data: 'Division_Name', name: 'Division_Name', class: 'align-middle booking_type_name',text:'Division Name',download:true},
            {data: 'Division_code', name: 'Division_code', class: 'align-middle created_at',text:'Division Code',download:true},
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('manage/divisions/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
