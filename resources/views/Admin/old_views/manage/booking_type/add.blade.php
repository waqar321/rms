...
@section('title')  {{ (Request::segment(3) == 'edit') ? 'Edit' : 'Add' }} Booking Type @endsection
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="booking_type" action="" novalidate="novalidate" data-parsley-validate class="form-horizontal form-label-left" method="post">
                                <input type="hidden" value="" disabled name="id">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Booking Type Name</label>
                                        <input data-rule-required="true"  data-msg-required="This is required" id="booking_type_name" class="form-control" type="text" name="booking_type_name">
                                        <span class="error-container danger w-100"></span>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <a href="<?php echo url_secure('manage/booking_type/index') ?>"><button class="btn btn-danger cancel-button" type="button">Cancel</button></a>
...
@section('scripts')
    ...
    <script>
            ...
            submitHandler: function (form, event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var data = $('#booking_type').serialize();
                        $.ajax({
                            url: '<?php echo api_url('manage/booking_type/submit'); ?>',
                            method: 'POST',
                            data:data,
                            headers: headers,
                            ...
                            success: function(data) {
                                if (data && data.status == 1) {
                                    ...
                                    window.location.href = '<?php echo url_secure('/manage/booking_type/index') ?>'
                                } else {
        ...
        if(url) {
            ...
            $.ajax({
                url: '<?php echo api_url('manage/booking_type/edit'); ?>',
                method: 'GET',
                ...
                success: function (data) {
                    if (data && data.status == 1) {
                        editForm(data.data.booking_types);
                    } else {
                        Swal.fire(
                            'Error!',
