...
@section('title')  {{ (Request::segment(3) == 'edit') ? 'Edit' : 'Add' }} Bank @endsection
@section('styles')
@endsection
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="bank_form" action="" novalidate="novalidate" data-parsley-validate class="form-horizontal form-label-left" method="post">
                                <input type="hidden" value="" disabled name="id">

                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Bank Type<span class="danger">*</span></label>
                                        <select  data-rule-required="true"  data-msg-required="This is required" name="bank_type_id" id="bank_type_id" class="form-control select2">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input  data-rule-required="true"  data-msg-required="This is required" id="bank_name" class="form-control" type="text" name="bank_name">
                                        <span class="error-container danger w-100"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <div class="form-group">
                                        <a href="<?php echo url_secure('manage/bank/index') ?>"><button class="btn btn-danger cancel-button" type="button">Cancel</button></a>
...
<script>
    ...
    function loadAjax(EditData = []){
        $.ajax({
            url: '<?php echo api_url('manage/bank_type/list'); ?>',
            method: 'GET',
            headers: headers,
            ...
            success: function (data) {
                ...
                $.each(data, function(index, value) {
                    option+= `<option value="${value.id}">${value.bank_type_name}</option>`
                });
                $('#bank_type_id').append(option);
                if(EditData){
                    editForm(EditData);
                }
            },
        ...
        submitHandler: function (form, event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo api_url('manage/bank/submit'); ?>',
                        method: 'POST',
                        data:data,
                        headers: headers,
                        dataType: 'json', // Set the expected data type to JSON
                        ...
                        success: function(data) {
                            if (data && data.status == 1) {
                                ...
                                window.location.href = '<?php echo url_secure('/manage/bank/index') ?>'
                            } else {
    ...
    if(url) {
        ...
        $.ajax({
            url: '<?php echo api_url('manage/bank/edit'); ?>',
            method: 'GET',
            headers: headers,
