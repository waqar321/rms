...
{{--                    </form>--}}
                    ...
                    <div class="x_content">
                        <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="19">
                            <div class="col-md-4 col-sm-4 col-xs-12">
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('manage/services/index') ?>',
            data: function (d) {
                d.ajax = 1;
            },
            headers: headers
        ...
        columns: [
            ...
            {data: 'service_name', name: 'service_name', class: 'align-middle booking_type_name',text:'Service Name',download:true},
            {data: 'service_code', name: 'service_code', class: 'align-middle created_at',text:'Service Code',download:true},
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('manage/services/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
