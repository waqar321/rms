                                            ...
                                            <div class="form-horizontal">
                                                <div class="row form-body">
                                                    <div class="col-md-12">
                                                        ...
                                                        <label class="control-label col-md-4">Applicable Date: <strong id="applicable_date">01/02/2023</strong>
                                                            <select  class="form-control" name="traiff_date" id="traiff_date" onchange="viewTariff()">
                                                                <option selected>Please Select</option>
                                                            </select>
                                                        </label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-4">
                                                            <label class="trafic-text">Charges Type : </label>
                                                             <span>
                                                                 <input type="text" name="charge_type" id="charge_type" value="">
                                                             </span>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('scripts')
    <script>
        ...
        if (url) {
            ...
            // $.ajax({
            //     url: '<?php echo api_url('manage_cheque/add_tariff'); ?>',
            //     method: 'GET',
        ...
        function shipmentCharges(data) {
            ...
            Object.keys(data).forEach(function (index) {
                ...
                Object.keys(lssRefRateMatrixCorporate.zones).forEach(function (index2) {
                    ...
                    Object.keys(lssRefRateMatrixCorporate.weightRate).forEach(function (index3,weight_rates) {
                        var shipmentChargesData = lssRefRateMatrixCorporate.weightRate[index3];
                            ...
                            if(shipmentChargesData.rating_zone == ratingZone){
                                var weightDisabled;
                                if(shipmentChargesData.from_weight == 0){
                                    weightDisabled = 'disabled';
                                }
                                var tableListData = `<tr>
                                                <td><input type="text" name="from_weight" id="from_weight"  value="`+shipmentChargesData.from_weight+`" `+ weightDisabled +` style="width: 100%"></td>
                                                <td><input type="text" name="to_weight" id="to_weight"  value="`+shipmentChargesData.to_weight+`" style="width: 100%"></td>
                                                <td><input type="text" name="tarrif_rate" id="tarrif_rate"  value="`+shipmentChargesData.tarrif_rate+`" style="width: 100%"></td>
                                                <td><input type="text" name="return_rate" id="return_rate"  value="`+shipmentChargesData.return_rate+`" style="width: 100%"></td>
                                            </tr>`;
                    ...
                    var addRow = `<tr><td>Each Additional Weight</td><td><input type="text" name="add_weight" value="`+addWeight+`" style="width: 100%"></td>
<td><input type="text" name="add_charges" value="`+addCharges+`" style="width: 100%"></td><td><input type="text" name="return_charges" value="`+additionalReturncharges+`"style="width: 100%"></td></tr>`;
        ...
        function cashHandlingCharges(cashHandling){
            ...
            $('#charge_type').value = cashHandling[0].rate_type;
            ...
            Object.keys(cashHandling).forEach(function (index) {
                ...
                var cashHandlingChargeContent1 = `<tr>
                                                        <td><input type="text" name="from_amount" id="from_amount" value="`+cashHandlingCharge.from_amount+`"></td>
                                                        <td><input type="text" name="from_amount" id="from_amount" value="`+cashHandlingCharge.to_amount+`"></td>
                                                        <td><input type="text" name="from_amount" id="from_amount" value="`+cashHandlingCharge.rate+`"></td>
                                                    </tr>`;
                cashHandlingContent += cashHandlingChargeContent1;
                above_type = `<tfoot><tr><td>Above</td><td><input type="text" name="charges_type" id="charges_type" value="`+cashHandlingCharge.above_charges_type+`"></td><td><input type="text" name="above_charges_rate" id="above_charges_rate" value="`+cashHandlingCharge.above_charges_rate+`"></td></tr></tfoot>`;
            });
