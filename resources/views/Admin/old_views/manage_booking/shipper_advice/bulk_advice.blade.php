                        ...
                        <form id="import-csv" action="" novalidate="novalidate" data-parsley-validate method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="file" id="csv_file" name="csv_file" data-rule-required="true"  data-msg-required="Please Upload Csv File First" class="form-control"  accept=".csv">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3 col-xs-12 buttons-div">
                                    ...
                                    <a download href="{{ url_secure('sample/shipper_advice_sample_file.csv?id=1') }}" class="btn btn-info"> <i class="fa fa-download" aria-hidden="true"></i> download sample file</a>
                                    </div>
                                    <button type="submit" class="btn btn-success col-md-2 upload-button">Upload</button>
                                    <a href="<?php echo url_secure('manage_booking/shipper_advice') ?>"><button type="button" class="btn btn-danger btn-default col-md-2">Cancel</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    $("#import-csv").validate({
        ...
        submitHandler: function (form, event) {
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '<?php echo api_url('manage_booking/shipper_advice/import/process'); ?>',
                    method: 'POST',
                    data:formData,
                    headers: headers,
