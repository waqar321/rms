...
@section('title') Vendor Pickup Reversal @endsection
@section('styles')
    <style>
        .labels {
        ...
        <div class="">
            ...
            <div class="row equal d-lg-flex">
                <form id="booking_form" action="" novalidate="novalidate" data-parsley-validate
                    ...
                    <input type="hidden" name="booked_packet_cn" id="booked_packet_cn">
                    <input type="hidden" name="booking_reversal" id="booking_reversal" value="1">
                            ...
                            <div class="x_content" style="padding: 5px 5px 15px 5px;height: 1100px;">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12 mb-2">
                                        ...
                                        <select data-rule-required="true" readonly
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12 mb-2">
                                        ...
                                        <select class="select2 form-control" tabindex="-1" name="client_id"
                                                id="client_id" data-rule-required="true"  readonly
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <input data-rule-required="true" readonly
                                               data-msg-required="This field is required"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <input data-rule-maxlength="11"
                                               ...
                                               class="form-control"
                                               type="text" name="booked_packet_order_id">
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        function editForm(data) {
            ...
            $(keys).each(function (index, element) {
                ...
                if (input.is(':checkbox')) {
                    ...
                    if (element === 'shipper_name') {
                        input.val(data.consignee_name);
                    }
                    else if (element === 'shipper_email') {
                        input.val(data.consignee_email);
                    }
                    else if (element === 'shipper_phone') {
                        console.log(input,data.consignee_phone)
                        input.val(data.consignee_phone);
                    }
                    else if (element === 'shipper_address') {
                        input.val(data.consignee_address);
                    }
                    else if (element === 'consignee_name') {
                        input.val(data.shipper_name);
                    }
                    else if (element === 'consignee_email') {
                        input.val(data.shipper_email);
                    }
                    else if (element === 'consignee_phone') {
                        input.val(data.shipper_phone);
                    }
                    else if (element === 'consignee_address') {
                        input.val(data.shipper_address);
                    }
                    else if (element === 'booked_packet_order_id') {
                        input.val(data.booked_packet_cn);
                    }
                    else if (element === 'booked_packet_date') {
                        input.val(new Date().toLocaleDateString('en-CA'));
                    }
                    else if (element === 'consignee_id') {
                        input.val(data.consignee_id);
                    }
                    else if (element === 'shipper_id') {
                        input.val(data.shipper_id);
                    }
                    else{
                        input.val(values[index]);
                    }
