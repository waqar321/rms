...
@section('title') Manage GST Invoices @endsection
@section('styles')
    <style>
        .x_title {
             margin-bottom: 13px;
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                            <label>Search By States</label>
                            <select class="form-control select2" onchange="search()" name="state_id" id="state_id">
                                <option value="">View All</option>
                            </select>
                        </div>
            ...
            <div class="modal-body" style="max-height: 400px;overflow: auto;">
                ...
                <div class="row">
                    <div class="col-md-6 text-center" style="border-right: 1px solid #c2cad8;">
                        ...
                        <div>
                            <button data-type="summary" class="print_invoice invoiceId">Print</button> | <a target="_blank" data-initial-href="manage_gst_invoice/invoice/summary/PDF/" href="manage_gst_invoice/invoice/summary/PDF/" class="print_summary invoiceId">PDF</a> | <a target="_blank" data-initial-href="manage_gst_invoice/invoice/summary/Excel/" href="manage_gst_invoice/invoice/summary/Excel/" class="excel_invoice invoiceId">Excel</a>
                        </div>
                    </div>
                    <div class="col-md-6 text-center">
                        <div>
                        ...
                        <div>
                            <button data-type="details" class="print_invoice invoiceId">Print</button> | <a target="_blank" data-initial-href="manage_gst_invoice/invoice/detail/PDF/" href="manage_gst_invoice/invoice/detail/PDF/" class="print_summary invoiceId">PDF</a> | <a target="_blank" data-initial-href="manage_gst_invoice/invoice/detail/Excel/" href="manage_gst_invoice/invoice/detail/Excel/" class="excel_invoice invoiceId">Excel</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function getCitiesList(){
        ...
        $("#state_id").select2({
                ...
                allowClear: true,
                ajax: {
                    url: "{{ api_url('get_states') }}", // Replace with your actual server endpoint
                    dataType: "json",
                    delay: 250, // Delay before sending the request in milliseconds
                    headers: headers,
                    processResults: function (data) {
    ...
    var table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('manage_gst_invoice') ?>',
            data: function (d) {
        ...
        order: [[2, 'desc']],
        columns: [
            {data: 'serial_number', orderable: false, searchable: false, name: 'serial_number', class: 'align-middle serial_number', render: function (data, type, row) {return '';} ,download:false},
            {data: 'merchant_name', name: 'merchant_name', class: 'align-middle merchant_name',text:'Client',download:true},
            {data: 'state_name', name: 'state_name' , class: 'align-middle state_name',text:'State Name',download:true},
            {data: 'invoice_number', name: 'invoice_number' , as : 'invoice_number' , class: 'align-middle invoice_number',text:'Invoice Number',download:true},
            {data: 'invoice_date', name: 'invoice_date' , class: 'align-middle invoice_date',text:'Invoice Date',download:true},
            {data: 'total_packets', name: 'total_packets', class: 'align-middle total_packets',text:'Total Packets',download:true},
            {data: 'gross_total', name: 'gross_total', class: 'align-middle gross_total',text:'Invoice Amount',download:true,
                "render": function (data, type, row) {
                    // Format the number as currency with commas
                    return Math.round(parseFloat(data)).toLocaleString('en-IN');
                }
            },
            {data: 'created_at', name: 'ecom_gst_invoice_master.created_at' , class: 'align-middle created_at',text:'Date Added',download:true},           
    ...
    $('body').delegate('.print_invoice', 'click', function(e) {
        ...
        if(invoiceType=='details'){
            var url = `<?php echo api_url('manage_gst_invoice/invoice/detail/Print/') ?>` + invoiceId;
        }
        else{
            var url = `<?php echo api_url('manage_gst_invoice/invoice/summary/Print/') ?>` + invoiceId;
        }
