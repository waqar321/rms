...
@section('title') {{ (Request::segment(3) == 'edit') ? 'Edit' : 'Add' }} CN @endsection
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Add <strong id="last_used_cn"></strong></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form id="cn_form" action="" novalidate="novalidate" data-parsley-validate
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label>Manual/CSV<span class="danger">*</span></label>
                                        <select data-rule-required="true" data-msg-required="This is required"
                                                name="isCSV" id="isCSV" class="form-control select2">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label>CN Type<span class="danger">*</span></label>
                                        <select onchange="cn_change(this.value)" data-rule-required="true"
                                                data-msg-required="This is required" name="register_cert_option"
                                                id="register_cert_option" class="form-control select2">
                                            <option value="2">Bulk CN</option>
                                            <option value="1">Single CN</option>
                                        </select>
                                        <span class="error-container danger w-100"></span>
                                    </div>
                                </div>
                                <div class="cn_single"  style="display: none">
                                    <div class="col-md-6 col-sm-6 col-xs-12">

                                        <div class="form-group">
                                            <label>CN No. <span class="danger">*</span></label>
                                            <input autocomplete="off" type="number" minlength="9" maxlength="9"
                                                   data-rule-required="true" data-msg-required="This is required"
                                                   name="register_cert_no" id="register_cert_no" class="form-control"/>
                                            <span class="error-container danger w-100"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cn_bulk">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label>CN No. Start <span class="danger">*</span></label>
                                            <input autocomplete="off" type="number" minlength="9" maxlength="9"
                                                   data-msg-required="This is required" name="register_cert_no_start"
                                                   id="register_cert_no_start" class="form-control"/>
                                            <span class="error-container danger w-100"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label>CN No. End. <span class="danger">*</span></label>
                                            <input autocomplete="off" type="number" minlength="9" maxlength="9"
                                                   data-msg-required="This is required" name="register_cert_no_end"
                                                   id="register_cert_no_end" class="form-control"/>
                                            <span class="error-container danger w-100"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <a href="<?php echo url_secure('manage_location/cn') ?>">
...
@section('scripts')
    ...
    <script>
        ...
        function loadAjax(EditData = []) {
            ...
            $.ajax({
                url: '<?php echo api_url('manage_location/cn/last_used_cn'); ?>',
                method: 'GET',
                dataType: 'json', // Set the expected data type to JSON
                headers: headers,
                beforeSend: function () {
                ...
                success: function (data) {
                    if(data.data.last_used_cn) {
                        $('#last_used_cn').html('Last Used Cn : ' + data.data.last_used_cn);
                    }
                },
                error: function(xhr, textStatus, errorThrown) {
        ...
        $("#cn_form").validate({
            ...
            submitHandler: function (form, event) {
                ...
                $('.submit-and-update-button').prop('disabled',true);
                Swal.fire({
                    title: 'Are you sure?',
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data && data.status == 1) {
                                    ...
                                    $('.submit-and-update-button').prop('disabled',false);
                                }
                            },
                            complete: function() {
                                sw.close();
