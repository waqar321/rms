...
@section('title') Express Centre Listing @endsection
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        buttons: [
            {
                text: '<i class="la la-cogs"></i> Add Express Centre',
                className: 'btn btn-primary btn-sm add',
                action: function (e, dt, node, config) {
                    window.location = '<?php echo url_secure('manage_location/express_centre/add') ?>';
                }
            },
        ],
        select: {
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('manage_location/express_centre') ?>',
            data: function (d) {
                d.ajax=1;
            },
            headers: headers,
        ...
        columns: [
            ...
            {data: 'id', name: 'ecom_branch.id', class: 'align-middle id',text:'Sys ID#' ,download:true},
            {data: 'city_name', name: 'c.city_name', class: 'align-middle city_name',text:'City Name',download:true},
            {data: 'branch_name', name: 'ecom_branch.branch_name', class: 'align-middle branch_name',text:'Express Center Name',download:true},
            {data: 'branch_phone', name: 'ecom_branch.branch_phone', class: 'align-middle branch_phone',text:'Center Phone',download:true},
            {data: 'created_at', name: 'ecom_branch.created_at', class: 'align-middle created_at',text:'Date Created',download:true},
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('manage_location/express_centre/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
