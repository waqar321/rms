...
@section('title') {{ (Request::segment(3) == 'edit') ? 'Edit' : 'Add' }} State @endsection
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="state_form" action="" novalidate="novalidate" data-parsley-validate class="form-horizontal form-label-left" method="post">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <label>State Name<span class="danger">*</span></label>
                                        <input  data-rule-required="true"  data-msg-required="This is required" id="state_name" class="form-control" type="text" name="state_name">
                                        <span class="error-container danger w-100"></span>
                                    </div>
                                </div>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <div class="form-group">
                                    <label>GST (%)<span class="danger">*</span></label>
                                        <input data-rule-min="0"  data-rule-required="true"  data-msg-required="This is required" id="gst" class="form-control" type="number" name="gst">
                                        <span class="error-container danger w-100"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <a href="<?php echo url_secure('manage_location/state') ?>"><button class="btn btn-danger cancel-button" type="button">Cancel</button></a>
...
@section('scripts')
    ...
    <script>
            ...
            submitHandler: function (form, event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?php echo api_url('manage_location/state/submit'); ?>',
                            method: 'POST',
                            data:data,
                            headers: headers,
                            dataType: 'json', // Set the expected data type to JSON
                            ...
                            success: function(data) {
                                if (data && data.status == 1) {
                                    ...
                                    window.location.href = '<?php echo url_secure('/manage_location/state') ?>'
                                } else {
        ...
        if(url) {
            ...
            $.ajax({
                url: '<?php echo api_url('manage_location/state/edit'); ?>',
                method: 'GET',
