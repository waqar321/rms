...
@section('title') {{ (Request::segment(3) == 'edit') ? 'Edit' : 'Add' }} City @endsection
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <br/>
                            <form id="city_form" action="" novalidate="novalidate" data-parsley-validate
...
@section('scripts')
    ...
    <script>
            ...
            submitHandler: function (form, event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?php echo api_url('manage_location/city/submit'); ?>',
                            method: 'POST',
                            data: data,
                            headers: headers,
                            dataType: 'json', // Set the expected data type to JSON
                            ...
                            success: function (data) {
                                if (data && data.status == 1) {
                                    ...
                                    window.location.href = '<?php echo url_secure('/manage_location/city') ?>'
                                } else {
        ...
        if (url) {
            ...
            $.ajax({
                url: '<?php echo api_url('manage_location/city/edit'); ?>',
                method: 'GET',
