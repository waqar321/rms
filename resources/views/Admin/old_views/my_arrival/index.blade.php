            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="col-md-12 mt-4">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="client_region" name="client_region" class="form-control select2" >
                            ...
                            <div class="col-md-4 ">
                                <div class="form-group">
                                    <label class="">Destination City</label>
                        ...
                        <div class="x_content">
                            <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="110">
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo api_url('manage_booking/my_arrivals/my_arrival_index') ?>',
                data: function (d) {
                    d.ajax = 1;
                    d.status = $('#status').val();
            ...
            columns: [
                ...
                {data: 'merchant_account_no', name: 'em.merchant_account_no', class: 'align-middle merchant_account_no',text:'Company Account',download:true},
                ...
                {data: 'origin_city', name: 'or.city_name', class: 'align-middle origin_city',text:'Origin',download:true},
                {data: 'destination_city', name: 'ds.city_name', class: 'align-middle destination_city',text:'Destination' ,as : 'destination_city',download:true},
                {data: 'shipper_name', name: 'es.merchant_name', class: 'align-middle shipper_name',text:'Shipper',download:true},
                {data: 'consignee_name', name: 'ec.consignee_name', class: 'align-middle consignee_name',text:'Consignee',download:true},
                {data: 'consignee_address', name: 'ec.consignee_address', class: 'align-middle consignee_address limited',text:'Consignee Address',download:true},
        ...
        option += `<option value="ebppr.deposited_amount">Deposit Received</option>`;
        ...
        jQuery(function ($) {
            ...
            $('#export-csv').submit(function (e) {
                ...
                if (!$('#export').val()) {
                    ...
                    // Set the specific date (January 1, 2022)
                    const specificDate = new Date('2022-01-01');

                    // Format the dates
                    const formattedCurrentDate = currentDate.toLocaleDateString('en-US');
                    const formattedSpecificDate = specificDate.toLocaleDateString('en-US');

                    $.ajax({
                        url: '<?php echo api_url('manage_booking/my_arrivals/downloadCsv') ?>', // Replace with your backend URL
                        type: 'GET',
                        headers: headers,
                        data: {
                            ...
                            date : formattedSpecificDate+'-'+formattedCurrentDate,
