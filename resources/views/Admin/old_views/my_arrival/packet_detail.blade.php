<style>
    ...
    .col-md-4.text-center.tracking-info p {
...
<div style="overflow-x: hidden;" id="bgSetter">
    ...
    <div class="container">
        <div class="row">
            ...
            @if(request()->is_admin == 1)
                <div class="col-md-4 text-center tracking-info">
                    <p class="mb-1" align="left"><strong>Tracking #:</strong>{{ $booked_packetObj['tracking_detail']['booked_packet_cn']}}</p>
                    <p class="mb-1" align="left"><strong>Shipper Name :</strong> <?php if ($booked_packetObj['tracking_detail']['merchant_contact_person'] == '') { ?><?php echo $booked_packetObj['tracking_detail']['shipper_name']; ?><?php } else { echo $booked_packetObj['tracking_detail']['merchant_contact_person']; } ?></p>
                    <p class="mb-1" align="left"><strong>Shipper Address :</strong> <?php if ($booked_packetObj['tracking_detail']['shipper_address'] != '') { ?><?php echo $booked_packetObj['tracking_detail']['shipper_address']; ?><?php } else { ?>N/A<?php } ?></p>
                </div>
                <div class="col-md-4 text-center tracking-info">
                    <div class="corier_van">
                        <p class="mb-1" align="center">({{ $booked_packetObj['tracking_detail']['booked_packet_status_message']}})</p>
                    </div>
                </div>
                <div class="col-md-4 text-center tracking-info">
                    <p class="mb-1" align="left"><strong>Reference # / Order ID:</strong>{{ $booked_packetObj['tracking_detail']['booked_packet_order_id']}}</p>
                    <p class="mb-1" align="left"><strong>Consignee Name :</strong> <?php if ($booked_packetObj['tracking_detail']['consignment_name'] != '') { ?><?php echo $booked_packetObj['tracking_detail']['consignment_name']; ?><?php } else { ?>N/A<?php } ?></p>
                    <p class="mb-1" align="left"><strong>Consignee Address :</strong><br> <?php if ($booked_packetObj['tracking_detail']['consignment_address'] != '') { ?><?php echo $booked_packetObj['tracking_detail']['consignment_address']; ?><?php } else { ?>N/A<?php } ?></p>
                </div>
            @else
                <div class="col-md-4 text-center tracking-info">
                    <p class="mb-2">From</p>
                    <h1 class="mb-1">{{ $booked_packetObj['tracking_detail']['origin_city_name'] }}</h1>
                </div>
                <div class="col-md-4 text-center tracking-info">
                    <div class="corier_van">
                        <p class="mb-1">{{ $booked_packetObj['tracking_detail']['booked_packet_status_message']}}</p>
                    </div>
                </div>
                <div class="col-md-4 text-center tracking-info">
                    <p class="mb-2">To</p>
                    <h1 class="mb-1">{{ $booked_packetObj['tracking_detail']['destination_city_name'] }}</h1>
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="container">
        <div class="row" style="height:150px;overflow-y: scroll">
            <table class="table table-bordered track-history">
                <thead>
