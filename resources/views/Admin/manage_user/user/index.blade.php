...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        buttons: [
            {
                text: '<i class="la la-cogs"></i> Add User',
                className: 'btn btn-primary btn-sm add',
                action: function (e, dt, node, config) {
                    window.location = '<?php echo url_secure('manage_user/add') ?>';
                },
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('manage_user') ?>',
            data: function (d) {
                d.ajax=1;
                d.status = $('#status').val();
        ...
        columns: [
            ...
            {data: 'username', name: 'ecom_admin_user.username', class: 'align-middle created_at',text:'User Name',download:true},
            {data: 'email', name: 'ecom_admin_user.email', class: 'align-middle created_at',text:'User Id (Email)',download:true},
    ...
    jQuery(function ($) {
        ...
        $('#export-csv').submit(function (e) {
            ...
            if (!$('#export').val()) {
                ...
                $.ajax({
                    url: '<?php  echo api_url('manage_user/downloadCsv')  ?>', // Replace with your backend URL
                    type: 'GET',
                    data: {
