        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form method="POST" enctype="multipart/form-data" action="#" id="export-csv" data-screen-permission-id="10">
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        buttons: [
            {
                ...
                action: function (e, dt, node, config) {
                    window.location = '<?php echo url_secure('manage_user/roles/add') ?>';
                },
                init: function (dt, node, config) {
                    // Add custom data attributes to the button
                    $(node).attr('data-screen-permission-id', "7");
                }
            },
        ],
        select: {
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo api_url('manage_user/roles/index') ?>',
            data: function (d) {
                d.ajax = 1;
            },
            headers: headers,
        ...
        columns: [
            ...
            {data: 'id', name: 'ecom_user_roles.id', class: 'align-middle id',text:'Sys ID#' ,download:true},
            {data: 'role_name', name: 'ecom_user_roles.role_name', class: 'align-middle role_name',text:'Role Name',download:true},
            {data: 'created_at', name: 'ecom_user_roles.created_at', class: 'align-middle created_at',text:'Date Created',download:true},
