...
@section('title')
    {{ (Request::segment(3) == 'edit') ? 'Edit' : 'Add' }}Role
@endsection
@section('styles')
@endsection
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="role-form" action="" novalidate="novalidate" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                                <input type="hidden" value="" disabled name="id">
                                <div class="col-md-7 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Role Name<span class="danger">*</span></label>
                                        <input id="role_name" class="form-control" type="text" name="role_name" data-rule-required="true"  data-msg-required="role name is required">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <select id="admin_user_id" name="admin_user_id" class="form-control select2"  data-rule-required="true"  data-msg-required="Admin name is required">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <div class="form-group">
                                        <a href="<?php echo url_secure('manage_user/roles/index') ?>"><button class="btn btn-danger cancel-button" type="button">Cancel</button></a>
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#admin_user_id").select2({
                ...
                allowClear: true,
                ajax: {
                    url: "{{ api_url('clients_list_parent') }}", // Replace with your actual server endpoint
                    dataType: "json",
            ...
            submitHandler: function (form, event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?php echo api_url('manage_user/roles/merchant/submit'); ?>',
                            method: 'POST',
                            data:data,
                            headers: headers,
                            ...
                            success: function(data) {
                                if (data && data.status == 1) {
                                    ...
                                    window.location.href = '<?php echo url_secure('/manage_user/roles/merchant/index') ?>'
                                } else {
        ...
        if(url) {
            ...
            $.ajax({
                url: '<?php echo api_url('manage_user/roles/merchant/edit'); ?>',
                method: 'GET',
        ...
        function editForm(data) {
            ...
            $(keys).each(function (index, element) {
                ...
                }else if (element === 'admin_user_id') {
                    var option = new Option(data.admin_user.merchant.merchant_name,data.admin_user_id, true, true);
                    $('#admin_user_id').append(option).trigger('change');
