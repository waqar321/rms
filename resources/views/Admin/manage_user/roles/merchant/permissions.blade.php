                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-left from-input-col mt-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="{{ route('merchant.roles.index') }}"  class="btn btn-default" id="cancel"> Cancel </a>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
@section('scripts')
    <script src="<?php echo secure_url('vendors/validate/jquery.validate.min.js') ?>" type="text/javascript"></script>
    ...
    <script>
        ...
        $("#permission-form").validate({
            ...
            submitHandler: function (form, event) {
                ...
                Swal.fire({
                    title: 'Auto close when permission is update!',
                ...
                $.ajax({
                    url: '<?php echo api_url('manage_user/roles/merchant/permission/submit'); ?>',
                    method: 'POST',
                    data:data,
                    ...
                    success: function(data) {
                        if (data && data.status == 1) {
                            ...
                            {{--window.location.href = '<?php echo secure_url('/merchant/roles/index') ?>'--}}
                        } else {
        ...
        if(url) {
            ...
            $.ajax({
                url: '<?php echo api_url('manage_user/roles/merchant/permission'); ?>',
                method: 'GET',
        ...
        function permissionsList(modules){
            ...
            console.log(ecom_module_permissions);
            ...
            Object.keys(modules.permissions_list).forEach(function(index) {
                ...
                var permissionContent = `<div class="col-md-12"><p class="section-heading">`+perModule.module_name+` <input type="checkbox" ${selectedModule} id="module-id-`+perModule.id+`" onclick="moduleChecked(`+perModule.id+`)"></p></div>`;
                ...
                Object.keys(perModule.sub_module).forEach(function(array) {
                    ...
                    Object.keys(perSubModule.submodule_screen).forEach(function(key) {
                        ...
                        var subPermissionScreenContent = `<div class="col-md-2 offset-1 col-sm-2 from-input-col">
                                                            <div class="form-group">
